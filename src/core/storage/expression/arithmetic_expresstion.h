...
public:
    ...
    SqlTypes apply(const JoinedTuple &tuple) override {
        ...
        SqlFloatType x = std::holds_alternative<SqlFloatType>(left)
                             ? std::get<SqlFloatType>(left)
                             : std::get<SqlIntType>(left);
        SqlFloatType y = std::holds_alternative<SqlFloatType>(right)
                             ? std::get<SqlFloatType>(right)
                             : std::get<SqlIntType>(right);
